...
def _git_commit(path: Path) -> str:
    ...
    # the MCP server's hot path can wedge indefinitely (a stuck `git rev-parse
    # HEAD` was seen alive 30+ min despite a timeout). Empty string keeps the
    # previous "unknown provenance" contract.
